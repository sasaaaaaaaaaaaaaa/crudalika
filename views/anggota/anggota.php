          ...
          <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    ...
                    <a href='index.php?halaman=edit_anggota&id_anggota=$data[id_anggota]' 
                    class='btn btn-sm btn-success'title='ubah data'>
                        <i class='fa fa-pencil-alt'></i></a>
                    <a href='db/db_anggota.php?proses=hapus&id_anggota=$data[id_anggota]' class='btn btn-sm btn-danger'title='hapus data'>
