<div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">tambah pinjam</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              
              <form action="db/db_pinjam.php?proses=insert" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    <label for="nama">tanggal pinjam</label>
                    <input type="text" class="form-control" id_pinjam="tanggal_pinjam" name= "tanggal_pinjam" 
